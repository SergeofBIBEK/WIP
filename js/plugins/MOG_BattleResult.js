...
BattleResult.prototype.createParameters = function() {
	...
	this._par.bitmap.drawText(this._actopar[1],x,y + 37.5 * 1,100,32);
	this._par.bitmap.drawText(this._actopar[2],x,y + 37.5 * 2,100,32);
	this._par.bitmap.drawText(this._actopar[3],x,y + 37.5 * 3,100,32);
	this._par.bitmap.drawText(this._actopar[4],x,y + 37.5 * 4,100,32);	
	this._par.bitmap.drawText(this._actopar[5],x,y + 37.5 * 5,100,32);
	this._par.bitmap.drawText(this._actopar[6],x,y + 37.5 * 6,100,32);
	this._par.bitmap.drawText(this._actopar[7],x,y + 37.5 * 7,100,32);
	this._par.bitmap.drawText(this._actopar[8],x,y + 37.5 * 8,100,32);
	var x = Moghunter.bresult_par2_x;
	var y = Moghunter.bresult_par2_y;	
	this._par.bitmap.drawText(this._actor._level,x,y,100,32);
	this._par.bitmap.drawText(this._actor.mhp,x,y + 37.5 * 1,100,32);
	this._par.bitmap.drawText(this._actor.mmp,x,y + 37.5 * 2,100,32);
	this._par.bitmap.drawText(this._actor.atk,x,y + 37.5 * 3,100,32);
	this._par.bitmap.drawText(this._actor.def,x,y + 37.5 * 4,100,32);	
	this._par.bitmap.drawText(this._actor.mat,x,y + 37.5 * 5,100,32);
	this._par.bitmap.drawText(this._actor.mdf,x,y + 37.5 * 6,100,32);
	this._par.bitmap.drawText(this._actor.agi,x,y + 37.5 * 7,100,32);
	this._par.bitmap.drawText(this._actor.luk,x,y + 37.5 * 8,100,32);	
